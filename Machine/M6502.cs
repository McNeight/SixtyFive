...
namespace SixtyFive
{
    ...
    public sealed class M6502
    {
        ...
        /// </summary>
        private const UInt16 NMI_VEC = 0xfffa;
        /// <summary>
        /// Reset vector
        /// </summary>
        private const UInt16 RST_VEC = 0xfffc;
        /// <summary>
        /// Interrupt Request vector
        /// </summary>
        private const UInt16 IRQ_VEC = 0xfffe;
        #endregion
        ...
        {
            SP++;
            return Mem[(UInt16)(0x0100 + SP)];
        }

        void push(Byte data)
        {
            Mem[(UInt16)(0x0100 + SP)] = data;
            SP--;
        }
        ...
        void interrupt(UInt16 intr_vector, bool isExternal)
        {
            if (isExternal)
            {
                fB = false;
