...
namespace SixtyFive
{
    ...
    {
        /// <summary>
        /// Lookup of instruction/mode to opcode
        /// </summary>
        private Hashtable OpcodeModes;
        ...
        /// <summary>
        /// Number of bytes in each addressing mode
        /// </summary>
        private Hashtable AdmodeLen;
        ...
        public int AsmLine(String line, Byte[] b, UInt16 addr)
        {
            string inst = "";
            string operand;
            string admode;
